...
//     <>
//     <Sidebar/>
//     {/* 2 component for instructor and student  */}
//     <div>HomeWork</div>
//     <div>HomeWork</div>
    ...
    <div className="flex flex-col"> 
      <section> 
        <div className="flex flex-row justify-between"> 
          <button className="bg-purple-800 text-white p-3 rounded-md"> 
            تسليم 
          </button> 
          <div> 
            <p className="text-">الثلاثاء</p> 
          </div> 
          <div> 
      ...
      <section className="flex flex-col" > 
        <textarea className="w-full border-2 my-3"> 
...
const Layout = ({children})=> { 
  ...
  return ( 
    <div className="flex h-screen"> 
      <div 
        className={` ${open ? "w-72" : "w-20 " } bg-[#260B3A] h-screen p-5  pt-8 relative duration-300`} 
      > 
        <img 
